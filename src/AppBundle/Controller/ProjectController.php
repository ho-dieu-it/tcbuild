...
class ProjectController extends BaseController
{
     ...
     *   * 'admin_project_index' is the route with a name that follows the same
     ...
     *
     *
     * @Route("/page.{pageNum}", name="project_index")
     *
     */
     ...
     * @Route("/chi-tiet/{slug}", name="project_show")
     */
    ...
    /**
     * @Route("/{slug}.{pageNum}", name="project_list")
     * @ParamConverter("post", class="AppBundle:PostCategory")
     * @Method("GET")
     */
    public function listAction(PostCategory $category, $pageNum)
    {
        $em = $this->getDoctrine()->getManager();
        $repo = $em->getRepository('AppBundle:Post');
        $repoCategory = $em->getRepository('AppBundle:PostCategory');
