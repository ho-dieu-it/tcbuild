...
class RecruitController extends BaseController
{
     ...
     *
     *
     * @Route("/page.{pageNum}", name="recruit_index")
     *
     */
    ...
    public function indexAction($pageNum)
    {
        ...
        return $this->render('recruit/list.html.twig', array(
            'posts' => $posts,
            'page' => $pageNum,
            'pagenums' => $pagenums,
            'hot_posts' => $hot_posts,
     ...
     * @Route("/chi-tiet/{slug}", name="recruit_show")
     */
    public function showAction(Post $post)
    {
        ...
        $repoCategory = $em->getRepository('AppBundle:PostCategory');
        $categories = $repoCategory->findByType(self::TYPE);
        return $this->render('recruit/show.html.twig', array(
            'post'        => $post,
            'categories'  => $categories,
    ...
    /**
     * @Route("/{slug}.{pageNum}", name="recruit_list")
